    ...
    return(
        <div className="mapDraw_positioning">
            ...
            <div className="mapDraw2_container">
                    ...
                    <button className="createText_button" style={{outline: textMode_active ? '0.2vw solid white' : ''}} onClick={() => { setShowPicker(false); setEraseDrawing(false); setTextMode_active(!textMode_active); }}>
