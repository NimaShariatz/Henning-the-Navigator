...
function Color_select({ onColorChange, onThicknessChange, showPicker, setShowPicker, eraseDrawing, setEraseDrawing }: ColorSelectProps) {
        ...
        <div className="mapDraw_container">
            ...
            <div className="mapdraw_representation">
                ...
                <button 
                    ...
                    onClick={() => { setEraseDrawing(false); setShowPicker(!showPicker); }} 
                    style={{ backgroundColor: rgbaString, outline: showPicker ? '0.2vw solid white' : '0.2vw solid transparent' }}
                >
                </button>

                <button className="eraser_button" style={{outline: eraseDrawing ? '0.2vw solid white' : ''}} onClick={() => { setEraseDrawing(!eraseDrawing); setShowPicker(false); }}>
