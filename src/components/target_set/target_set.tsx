            ...
            <div className="targetSet_container" style={{transform: openChevron ? 'translateX(-30vw)' : 'translateX(0)'}}>
                ...
                <div className="target_options_container">
                    <div className="target_top_flexContainer">
                        ...
                        <button className="target_button" ref={radar}>
                        ...
                        <button className="target_button" ref={factory}>
                         ...
                         <button className="target_button" ref={railway}>
                         ...
                         <button className="target_button" ref={train}>
                        ...
                        <button className="target_button" ref={oil}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="75%" height="75%" viewBox="0 0 512 512">
                        ...
                        <button className="target_button" ref={tank}>
                        ...
                        <button className="target_button" ref={convoy}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="75%" height="75%" viewBox="0 0 24 24">
                    ...
                    <div className="target_bottom_flexContainer">
                        ...
                        <button className="target_button" ref={truck}>
                        ...
                        <button className="target_button" ref={defence}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="85%" height="85%" viewBox="0 0 24 24">
                         ...
                         <button className="target_button" ref={artillary}>
                        ...
                        <button className="target_button" ref={airfield}>
                        ...
                        <button className="target_button" ref={antiair}>
                        ...
                        <button className="target_button" ref={unknown}>
