...
function Target_set({ onTargetSelectionChange, onColorChange }: TargetSetProps){
    ...
    const selectionTarget = [
        { value: 1, ref: radar, name: "radar" },
        { value: 2, ref: factory, name: "factory" },
        { value: 3, ref: railway, name: "railway" },
        { value: 4, ref: train, name: "train" },
        { value: 5, ref: oil, name: "oil" },
        { value: 6, ref: tank, name: "tank" },
        { value: 7, ref: convoy, name: "convoy" },
        { value: 8, ref: truck, name: "truck" },
        { value: 9, ref: defence, name: "defence" },
        { value: 10, ref: artillary, name: "artillary" },
        { value: 11, ref: airfield, name: "airfield" },
        { value: 12, ref: antiair, name: "antiair" },
        { value: 13, ref: unknown, name: "unknown" },
    ];
            ...
            <div className="targetSet_container" style={{transform: openChevron ? 'translateX(-30vw)' : 'translateX(0)'}}>
                ...
                <div className="target_options_container">
                    <div className="target_top_flexContainer">
                        ...
                        <button className={`target_button ${selectedTarget === 1 ? 'button_selected' : ''}`} ref={radar} onClick={() => handleTargetSelection(1)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="85%" height="85%" viewBox="0 0 24 24">
                                <g fill="none">
                                    ...
                                    <path style={{fill: changeColor ? '#2563ff' : '#ff3620'}} className="target_button_fill" d="M5.269 4.026c.557-.628 1.463-.628 2.044-.148l.105.095l4.848 4.847l.087-.087a1 1 0 0 1 
                    ...
                    <div className="target_bottom_flexContainer">
                        ...
                        <button className={`target_button ${selectedTarget === 8 ? 'button_selected' : ''}`} ref={truck} onClick={() => handleTargetSelection(8)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="87%" height="87%" viewBox="0 0 512 512">
                                <path style={{fill: changeColor ? '#2563ff' : '#ff3620'}} fillRule="evenodd" d="M138.667 341.333c17.673 0 32 14.327 32 32s-14.327 32-32 32s-32-14.327-32-32s14.327-32 32-32m256 0c17.673 0 32 14.327 32 32s-14.327 32-32 32s-32-14.327-32-32s14.327-32 32-32m-96-192v149.333H320v-128h106.667L469.334 256v106.666h-22.4C441.991 338.322 420.468 320 394.666 320s-47.325 18.322-52.266 42.666H190.933C185.992 338.322 164.47 320 138.667 320s-47.325 18.322-52.266 42.666H42.667V149.333zM256 192H85.334v106.666H256zm144.3 21.333h-37.632v42.666h58.965z" />
                            </svg>
                        </button>

                        <button className={`target_button ${selectedTarget === 9 ? 'button_selected' : ''}`} ref={defence} onClick={() => handleTargetSelection(9)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="85%" height="85%" viewBox="0 0 24 24">
                                <path style={{fill: changeColor ? '#2563ff' : '#ff3620'}} d="M6 6.39v4.7c0 4 2.55 7.7 6 8.83c3.45-1.13 6-4.82 6-8.83v-4.7l-6-2.25z" opacity="0.3" />
                                <path style={{fill: changeColor ? '#2563ff' : '#ff3620'}} d="M12 2L4 5v6.09c0 5.05 3.41 9.76 8 10.91c4.59-1.15 8-5.86 8-10.91V5zm6 9.09c0 4-2.55 7.7-6 8.83c-3.45-1.13-6-4.82-6-8.83v-4.7l6-2.25l6 2.25z" />
                            </svg>  
                        </button>

                         <button className={`target_button ${selectedTarget === 10 ? 'button_selected' : ''}`} ref={artillary} onClick={() => handleTargetSelection(10)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="80%" height="80%" viewBox="0 0 512 512">
                                <path style={{fill: changeColor ? '#2563ff' : '#ff3620'}} d="m372.386 52.97l-14.822 13.064l103.244 117.142l14.822-13.064zm-30.23 26.646l-36.649 32.303l15.549 17.64zm16.865 16.346l-20.442 48.382l-1.457 3.448l19.012 21.57l21.897-51.832zm-67.537 28.318L119.939 275.485l.054.062l-1.294 1.141c-19.625 17.298-36.277 35.67-49.407 53.91l92.854 105.356c19.745-10.734 40.062-24.948 59.687-42.246l1.295-1.143l.055.063l6.23-5.493l165.313-145.713zm102.615 11.482l-20.443 48.385l-1.456 3.445l20.838 23.641l21.897-51.83zm36.904 41.873l-20.441 48.385l-.973 2.303l37.194-32.783zM58.583 346.723c-4.228 6.959-7.93 13.848-11.015 20.592c-6.73 
