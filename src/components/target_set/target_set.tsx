...
function Target_set({ onTargetSelectionChange, onColorChange, selectedTarget }: TargetSetProps){
            ...
            <div className="targetSet_container" style={{transform: openChevron ? 'translateX(-30vw)' : 'translateX(0)'}}>
                ...
                <div className="target_options_container">
                    <div className="target_top_flexContainer">
                        ...
                        <button className={`target_button ${selectedTarget === 1 ? 'button_selected' : ''}`} onClick={() => handleTargetSelection(1)}>
                        ...
                        <button className={`target_button ${selectedTarget === 2 ? 'button_selected' : ''}`} onClick={() => handleTargetSelection(2)}>
                         ...
                         <button className={`target_button ${selectedTarget === 3 ? 'button_selected' : ''}`} onClick={() => handleTargetSelection(3)}>
                         ...
                         <button className={`target_button ${selectedTarget === 4 ? 'button_selected' : ''}`} onClick={() => handleTargetSelection(4)}>
                        ...
                        <button className={`target_button ${selectedTarget === 5 ? 'button_selected' : ''}`} onClick={() => handleTargetSelection(5)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="75%" height="75%" viewBox="0 0 512 512">
                        ...
                        <button className={`target_button ${selectedTarget === 6 ? 'button_selected' : ''}`} onClick={() => handleTargetSelection(6)}>
                        ...
                        <button className={`target_button ${selectedTarget === 7 ? 'button_selected' : ''}`} onClick={() => handleTargetSelection(7)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="75%" height="75%" viewBox="0 0 24 24">
                    ...
                    <div className="target_bottom_flexContainer">
                        ...
                        <button className={`target_button ${selectedTarget === 8 ? 'button_selected' : ''}`} onClick={() => handleTargetSelection(8)}>
                        ...
                        <button className={`target_button ${selectedTarget === 9 ? 'button_selected' : ''}`} onClick={() => handleTargetSelection(9)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="85%" height="85%" viewBox="0 0 24 24">
                         ...
                         <button className={`target_button ${selectedTarget === 10 ? 'button_selected' : ''}`} onClick={() => handleTargetSelection(10)}>
                        ...
                        <button className={`target_button ${selectedTarget === 11 ? 'button_selected' : ''}`} onClick={() => handleTargetSelection(11)}>
                        ...
                        <button className={`target_button ${selectedTarget === 12 ? 'button_selected' : ''}`} onClick={() => handleTargetSelection(12)}>
                        ...
                        <button className={`target_button ${selectedTarget === 13 ? 'button_selected' : ''}`} onClick={() => handleTargetSelection(13)}>
