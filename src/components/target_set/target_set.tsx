...
function Target_set({ onTargetSelectionChange, onColorChange, selectedTarget, points_set, showPicker, eraseDrawing, textMode_active, pointIsSelected }: TargetSetProps){
    ...
    const city = useRef<HTMLButtonElement>(null);
    ...
    const bridge = useRef<HTMLButtonElement>(null);
    ...
    const targetMap = useMemo(() => [//changed it from 'const targetMap = [' to useMemo which prevents unnecessary re-renders
        ...
        { value: 9, ref: bridge },
        { value: 10, ref: truck },
        { value: 11, ref: defense },
        { value: 12, ref: artillary },
        { value: 13, ref: airfield },
        { value: 14, ref: AA },
        { value: 15, ref: unknown }
    ], []);
    ...
    useEffect(() => {
        ...
        if((has_one_start_point || has_one_target_point) && selectedTarget >= 1 && selectedTarget <= 15){
    ...
    return (
            <div className="targetSet_container" style={{transform: openChevron ? 'translateX(-32.8vw)' : 'translateX(0)'}}>
                ...
                <div className="target_options_container">
                    <div className="target_top_flexContainer">
                        ...
                        <button className={"target_button"} onClick={() => handleTargetSelection(3)} ref={city}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="75%" height="75%" viewBox="0 0 24 24">
                                <path style={{fill: changeColor ? 'var(--blue_target)' : 'var(--red_target)'}} d="M19 15h-2v-2h2m0 6h-2v-2h2M13 7h-2V5h2m0 6h-2V9h2m0 6h-2v-2h2m0 6h-2v-2h2m-6-6H5V9h2m0 6H5v-2h2m0 6H5v-2h2m8-6V5l-3-3l-3 3v2H3v14h18V11z" />
                            </svg>
                        </button>

                        <button className={"target_button"} onClick={() => handleTargetSelection(4)} ref={rail}>
                         ...
                         <button className={"target_button"} onClick={() => handleTargetSelection(5)} ref={train}>
                        ...
                        <button className={"target_button"} onClick={() => handleTargetSelection(6)} ref={oil}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="75%" height="75%" viewBox="0 0 512 512">
                        ...
                        <button className={"target_button"} onClick={() => handleTargetSelection(7)} ref={tank}>
                        ...
                        <button className={"target_button"} onClick={() => handleTargetSelection(8)} ref={convoy}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="75%" height="75%" viewBox="0 0 24 24">
                    ...
                    <div className="target_bottom_flexContainer">
                        ...
                        <button className={"target_button"} onClick={() => handleTargetSelection(11)} ref={defense}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="85%" height="85%" viewBox="0 0 24 24">
                         ...
                         <button className={"target_button"} onClick={() => handleTargetSelection(12)} ref={artillary}>
                        ...
                        <button className={"target_button"} onClick={() => handleTargetSelection(13)} ref={airfield}>
                        ...
                        <button className={"target_button"} onClick={() => handleTargetSelection(14)} ref={AA}>
                        ...
                        <button className={"target_button"} onClick={() => handleTargetSelection(15)} ref={unknown}>
                ...
                <div className="chevron_button_container" onClick={handle_openChevron}>
                    <button className="chevron_button">
                        <svg className="chevron_svg" width="75%" height="75%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{transform: openChevron ? 'none' : 'rotate(180deg)'}}>
