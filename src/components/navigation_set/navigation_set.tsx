...
function Navigation_set({ onWaypointSelectionChange, points_set }: NavigationSetProps){
    ...
    const [targetColor, setTargetColor] = useState(true);
    const toggle_target_color = () => {
        setTargetColor(!targetColor);
        
        const targetElements = document.querySelectorAll('.target_button_fill');
        
        const newColor = targetColor ? 'var(--red_target)' : 'var(--blue_target)';
        
        targetElements.forEach(element => {//applies to all
            ...
            <div className="target_icons_set" ref={targets_button_container}>
                ...
                <div className="target_icons_row">
                    ...
                    <div className="target_set">
                        <div>
                            <button className="target_button" onClick={() => toggle_waypoint_suggestion(5)} ref={radar}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="85%" height="85%" viewBox="0 0 24 24">
                                    <g fill="none">
                                        ...
                                        <path className="target_button_fill" d="M5.269 4.026c.557-.628 1.463-.628 2.044-.148l.105.095l4.848 4.847l.087-.087a1 1 0 0 1 
                            ...
                            <button className="target_button" onClick={() => toggle_waypoint_suggestion(6)} ref={factory}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="75%" height="75%" viewBox="0 0 24 24">
                                    <path className="target_button_fill" d="M12 12V9.95l-5 2V10l-3 1.32V20h16v-8zm-3 6H7v-4h2zm4 0h-2v-4h2zm4 0h-2v-4h2z" opacity="0.3" />
                                    <path className="target_button_fill" d="M22 22H2V10l7-3v2l5-2v3h3l1-8h3l1 8zM12 9.95l-5 2V10l-3 1.32V20h16v-8h-8zM11 18h2v-4h-2zm-4 0h2v-4H7zm10-4h-2v4h2z" />
                                </svg>
                            </button>
                            ...
                            <button className="target_button" onClick={() => toggle_waypoint_suggestion(7)} ref={railway}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="75%" height="75%" viewBox="0 0 512 512">
	                                <path className="target_button_fill" d="M18 112v39h38v-39zm102 0v39h48v-39zm112 0v39h48v-39zm112 0v39h48v-39zm112 0v39h38v-39zM18 169v30h476v-30zm0 48v78h38v-78zm102 0v78h48v-78zm112 0v78h48v-78zm112 0v78h48v-78zm112 0v78h38v-78zM18 313v30h476v-30zm0 48v39h38v-39zm102 0v39h48v-39zm112 0v39h48v-39zm112 0v39h48v-39zm112 0v39h38v-39z" />
                                </svg>
                            </button>

                            <button className="target_button" onClick={() => toggle_waypoint_suggestion(8)} ref={refinery}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="75%" height="75%" viewBox="0 0 512 512">
                                    <path className="target_button_fill" d="M288 133v18h160v-18zm41 34v16h78v-16zM64 201c-5.75 0-10.406 1.939-15.074 6.023c-4.668 
                        ...
                        <div>
                            ...
                            <button className="target_button" onClick={() => toggle_waypoint_suggestion(15)} ref={airfield_2}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="85%" height="85%" viewBox="0 0 24 24">
                                    <path className="target_button_fill" d="M13.105 12.609v2.279a.12.12 0 0 0 .061.105l.622.355a.49.49 0 0 1 .242.365l.049.413a.243.243 0 0 1-.307.263l-1.641-.459a.5.5 0 0 0-.262 0l-1.641.459a.244.244 0 0 1-.308-.263l.05-.413a.49.49 0 0 1 .242-.365l.621-.355a.12.12 0 0 0 .062-.105v-2.279a.122.122 0 0 0-.137-.121l-3.485.435A.242.242 0 0 1 7 12.682v-.624a.49.49 0 0 1 .316-.455l3.5-1.313a.12.12 0 0 0 .079-.114v-.741a4.8 4.8 0 0 1 .1-.981a1.015 1.015 0 0 1 1.2-.833a1.06 1.06 0 0 1 .819.9l.015.094a6 6 0 0 1 .077.976v.587a.12.12 
                                    0 0 0 .079.114l3.5 1.313a.49.49 0 0 1 .316.455v.624a.243.243 0 0 1-.274.241l-3.484-.435a.12.12 0 0 0-.138.119" />
                                    <path className="target_button_fill" d="M12 21.933A9.933 9.933 0 1 1 21.933 12A9.944 9.944 0 0 1 12 21.933m0-18.866A8.933 8.933 0 1 0 20.933 12A8.943 8.943 0 0 0 12 3.067" />
                                </svg>
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="switch_buttons">
                        <button className="target_button" onClick={toggle_target_color} ref={change}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="75%" height="75%" viewBox="0 0 24 24">
