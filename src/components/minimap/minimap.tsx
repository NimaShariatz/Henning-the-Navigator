...
function Minimap({ 
    ...
    const get_minimap_target_icon = (type: number, isBlue: boolean) => {
        const fillColor = isBlue ? '#2563ff' : '#ff3620';
        
        switch(type) {
            case 1: // radar
                return (
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24">
                        <path fill={fillColor} d="M5.269 4.026c.557-.628 1.463-.628 2.044-.148l.105.095l4.848 4.847l.087-.087a1 1 0 0 1 1.497 1.32l-.083.094l-.087.087l4.347 4.348c.572.572.614 1.557-.053 2.15a8.97 8.97 0 0 1-4.466 2.142l-.341.051l.98 1.318a1.1 1.1 0 0 1-.766 1.751l-.116.006h-6.58a1.1 1.1 0 0 1-1.058-1.403l.04-.115l1.254-3.051A8.99 8.99 0 0 1 3 10a8.97 8.97 0 0 1 2.269-5.974" />
                    </svg>
                );
            case 2: // factory
                return (
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24">
                        <path fill={fillColor} d="M22 22H2V10l7-3v2l5-2v3h3l1-8h3l1 8zM12 9.95l-5 2V10l-3 1.32V20h16v-8h-8z" />
                    </svg>
                );
    ...
    return(
        <>
            <div className="minimap_container">
                ...
                <Target_set onTargetSelectionChange = {on_target_selection_change}  onColorChange={on_target_color_change}/>
