    ...
    //-----database related functions-----
        const createOnlineSession = async () => {
            /*
                ...
                and add document with created date, ownder id[Google], updated date, and empty nav
            */
            if (!user) {
            ...
            // Navigate to the new session. use useNavigate() as we need to go to <a/> AFTER the id is made as Destination is known in advance
            navigate(`/map/${docRef.id}`);//This is docRef.id not user.uid!! unique ID for each navigation instance, hanges every time you create a new session, Generated by addDoc() automatically
            } catch (error) {
    ...
    return(
        <div className="home_container">
            ...
            <div className="youtube_container">
                <a href="https://youtu.be/WZZ_Fq5xNOw" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" className="youtube_homeIcon" width="100%" height="100%" viewBox="0 0 256 180">
                        ...
                        <path fill="#f5fafb" d="m102.421 128.06l66.328-38.418l-66.328-38.418z" />
                    </svg>
                </a>
            </div>
